...
class Breadcrumb
{
	...
	public function __construct()
	{
		...
		if($front_page_title){
			$this->home_title = $front_page_title;
		} else {
	...
	public function the_breadcrumb(){
		...
		if ( !is_front_page() ) {
			...
			// Home page
			if(is_single()){
				echo '<li class="item-home breadcrumb-item"><a class="bread-link bread-home" href="' . get_the_permalink($idPage) . '">' . get_the_title($idPage) . '</a></li>';
