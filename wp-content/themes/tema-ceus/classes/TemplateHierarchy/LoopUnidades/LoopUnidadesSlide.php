...
class LoopUnidadesSlide extends LoopUnidades{
    ...
    ?>
        ...
        <div class="container slide-principal py-4">
            <div class="row">
                <?php
                    $unidade = '';
                    $args = array(
                ...
                <div id="carouselConstrutor" class="carousel slide col-sm-12" data-ride="carousel">
                    ...
                    <div class="carousel-inner color-<?php echo $infoBasicas['zona_sp']; ?>">
                                        ...
                                        <div class="conteudo-destaque">
                                            ...
                                            <div class="conteudo-info">
                                                ...
                                                <div class="carousel-title">
                                                    <p><a href="<?php echo get_permalink( $slide ); ?>"><?= get_the_title($slide); ?></a></p>
                                                </div>
                                                <?php 
