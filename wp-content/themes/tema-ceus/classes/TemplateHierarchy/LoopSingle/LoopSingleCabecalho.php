...
class LoopSingleCabecalho extends LoopSingle
{
	...
	public function cabecalhoDetalheNoticia(){
		...
		?>
		<div class="evento-title py-4 col-12 color-<?php echo $zona; ?>" id="Noticias">
            <div class="container">
                <div class="row bg-event-title">                   

                    <div class="col-md-7 py-4 px-5 evento-infos d-flex align-content-between flex-wrap">
						<div class="info-top w-100">
							<?php
							...
							<h1 class="m-0 py-2 w-100"><?php echo get_the_title(); ?></h1>
						...
						<div class="info-bottom w-100">
							<?php
								$post_categories = wp_get_post_categories( $post->ID );
								$local = get_field('localizacao', $post->ID); 
							?>

							<p class="evento-unidade m-0 w-100 pb-3">
