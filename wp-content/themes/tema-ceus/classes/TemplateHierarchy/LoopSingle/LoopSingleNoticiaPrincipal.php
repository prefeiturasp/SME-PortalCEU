				...
				<div class="col-md-5 evento-details d-block d-md-none">
					<table class="table border-right border-left border-bottom">                            
						<tbody>
							...
							<?php
								$deIdade = get_field('de_idade');
								$ateIdade = get_field('ate_idade');
								if($classi != '') : ?>
								<tr>
									<th scope="row" class="align-middle"><i class="fa fa-star" aria-hidden="true"></i></th>
									<td><?php 
										if($classi == 'livre'){
											echo '<p class="m-0"><span class="blue-info">Faixa etária</span> - Livre</p>';
										} elseif($classi == 'acima'){
											echo '<p class="m-0"><span class="blue-info">Faixa etária</span> - Acima de ' . $deIdade . ' anos</p>';
										} elseif($classi == 'abaixo'){
											echo '<p class="m-0"><span class="blue-info">Faixa etária</span> - Abaixo de ' . $deIdade . ' anos</p>';
										} elseif($classi == 'de_ate'){
											echo '<p class="m-0"><span class="blue-info">Faixa etária</span> - De ' . $deIdade . ' até ' . $ateIdade . ' anos</p>';
										}
									?></td>                                    
								</tr>
							<?php endif; ?>
